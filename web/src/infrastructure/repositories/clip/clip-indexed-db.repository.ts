...
import type { IClipStorageRepository, ClipPositionDetails } from "./clip.repository.interface";

export class IndexedDbClipRepository extends BaseIndexedDbRepository implements IClipStorageRepository {
