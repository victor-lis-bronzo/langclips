...
| **BR01** | Um 'clip' para ser considerado apto a 'deck' deve ter, no mínimo, 5 segundos de fala e no máximo 20s. Caso tenha mais, será cortado. | Experiência | Alta |
| **BR02** | O sistema dever ser permissivo em relação a "case sensitive" e "punctuation", ou seja, a resposta do usuário deve ser comparada com a resposta gerada pelo sistema desconsiderando maiúsculas, minúsculas e pontuações | Experiência | Média |
